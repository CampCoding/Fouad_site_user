    ...
    return (
        <div className="py-10 mx-auto">
            ...
            <div className="card mb-6">
                ...
                <p className="font-bold text-[17px] text-[#eee]">أخبارنا</p>
            </div>
            ...
            {!currentGroup ? (
                <div className="text-center py-20">
                    <Newspaper size={60} className="text-(--main-color)/30 mx-auto mb-4" />
                    <p className="text-white/50 text-[14px] mb-2">لا توجد أخبار</p>
                    <p className="text-white/30 text-[12px]">لم يتم نشر أي أخبار حتى الآن</p>
                </div>
            ) : (
                <>
                        ...
                        {currentGroup.items.map((news) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <p className="text-white/70 text-[13px] leading-7">{preview}</p>
                                    {isLong && (
                                        <button
                    ...
                    <div className="flex items-center justify-between gap-2 mt-6 px-1">
                        <button
                            onClick={goToNextDay}
                            disabled={!hasNext}
                            className={`flex items-center gap-2 px-4 py-2.5 rounded-md text-[12px] font-bold transition-colors ${hasNext
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2.5 rounded-md text-[12px] font-bold transition-colors ${hasPrevious
                                    ? 'bg-[#171717] border border-(--main-color) text-white hover:bg-(--main-color)/10'
                                    : 'bg-[#0d0d0d] border border-white/10 text-white/30 cursor-not-allowed'
                                }`}
                        >
                ...
                >
                    ...
                    >
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-white font-bold text-[15px]">فلترة الأخبار</h3>
                            <button
                                onClick={() => setShowFilter(false)}
                                className="w-8 h-8 rounded-full flex items-center justify-center hover:bg-white/10 transition-colors"
                            >
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            >
                                <div className="flex items-center gap-2 flex-1">
                                    ...
                                    <span className={tempFilterDate ? 'text-white' : 'text-white/40'}>
                                        {tempFilterDate
