...
import { Tag, X, ChevronLeft, ChevronRight, Calendar, Phone } from 'lucide-react';
...
export default function Offers() {
    ...
    const prevOffer = (e) => {
        e.stopPropagation();
        setActiveIndex((prev) =>
            prev === 0 ? OFFERS_DATA.length - 1 : prev - 1
        );
    };
    ...
    return (
        <div className="py-10 mx-auto">
            ...
            <div className="card mb-6">
                ...
                <p className="font-bold text-[17px] text-[#eee]">عروضنا</p>
            </div>
