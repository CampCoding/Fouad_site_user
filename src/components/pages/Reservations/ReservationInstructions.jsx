...
const data = [
  {
    id: 1,
    title:
      "يتولى فريق الأطباء في الوحدات الخارجية إجراء الفحص ضمن الإطار الزمني المحدد.",
  ...
  },
  {
    id: 2,
    title:
      "نظرًا لحساسية الوضع الصحي لأطفالنا ، فإننا نُولي عامل الوقت أولوية قصوى، ونعمل بكل جدية لضمان تقديم الرعاية اللازمة دون تأخير",
  ...
  },
  {
    id: 3,
    title:
      "سيتم ابلاغ الاطباء بنتيجة الفحص فور عمله لتمكينهم من التعامل مع الاطفال بما يخص حالة القلب بشكل سليم ",
  ...
  },
  {
    id: 4,
    title:
      "سيتم ارفاق التقارير النهائية في البرنامج فور صدوره بعد مراجعته من استشاريين المركز",
      ...
      <div className="flex flex-col justify-center items-center gap-1">
        ...
        <div className="border h-[40px] w-full flex justify-center items-center border-(--main-color) bg-[#171717] rounded-[4px]">
          <p className="text-white text-center font-bold">
            يرجي اتباع التعليمات الاتية
          </p>
        </div>

        <div className="flex flex-col mt-4 gap-3">
          {data?.map((item) => (
            <div key={item?.id} className="grid grid-cols-[8fr_4fr] gap-3">
              ...
              <div className="rounded-lg bg-(--main-bg-color)   p-2 flex justify-center items-center">
                <img
                  src={isExternal ? item?.external_img : item?.internal_img}
                  className="w-10 h-10"
                  alt=""
                />
              </div>
        ...
        <button className="auth_btn px-5 min-w-[250px] text-sm text-nowrap mx-auto! mt-3">
          لمزيد من المعلومات{" "}
        </button>
      </div>
    </div>
