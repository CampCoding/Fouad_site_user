...
const doctors = [
  {
    ...
    experience: "خبرة أكثر من 15 سنوات في تشخيص وعلاج أمراض قلب الأطفال.",
    price: 500,
    img: "/images/11.png"
  },
];
    ...
    return (
      <div className="flex flex-col gap-3 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className='flex flex-col gap-3'>
          <CustomSelect
            placeholder={"الخدمة"}
            options={[{ value: 'pediatric_checkup', label: 'كشف أطفال' }]}
        ...
        <div className="relative group">
          ...
          <div key={currentDoctor.id} className="bg-[#171717] border border-[#232323] rounded-[12px] p-6 flex flex-col items-center gap-4 relative overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-300">
            ...
            <div className="w-full h-full p-1 overflow-hidden bg-[#232323]">
              <img src={currentDoctor.img} alt={currentDoctor.name} className="w-full h-full object-contain" />
            </div>
