...
export default function ContactUsPage() {
  ...
  <button 
    ...
    type="button"
    className="auth_btn flex-1 flex items-center justify-center gap-2 rounded-md! py-3 px-2 font-bold text-[12px] shadow-[0_0_20px_rgba(var(--main-bg-rgb),0.15)] whitespace-nowrap text-center"
  >
    <FaFacebook size={14} />
    <span>قيمنا عبر Facebook</span>  
  </button>
