...
export default function HomeCard({ 
  ...
  return (
    <div
      onClick={onClick}
      style={style}
      className={`mx-auto cursor-pointer w-[100px] h-[100px] bg-[linear-gradient(90deg,rgba(36,36,36,0.63),rgba(64,64,64,0.63))] rounded-lg flex flex-col gap-[8px] items-center justify-center border-[2px] transition-all ${
